...
| TUI command | `/usr/bin/script -q <log> bun run packages/tui/src/index.ts --cwd <tmp> --model claude-haiku-4-5 --no-thinking --budget 1.00 --yield-after-ms 500 --timeout-ms 120000` |
...
- The workspace contains the expected files under the TUI `--cwd`, not a separate ad hoc `/tmp` project.
- Final independent port probe fails after the model stops the server.
- The TUI returns to idle and exits cleanly.
...
- The final TUI process returns to idle and closes on `/exit`.
...
- The model creates the project outside the TUI workspace.
...
- Date: 2026-06-19
- Workspace: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-D9Tahx`
- Log path: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-D9Tahx/tui-interactive-shell-control.log`
...
- Date: 2026-06-19
- Workspace: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-tHgX1K`
- Log path: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-tHgX1K/tui-interactive-shell-control.log`
...
- Date: 2026-06-19
- Workspace: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-Jk1VL1`
- Log path: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-Jk1VL1/tui-interactive-shell-control.log`
...
- Failure found: the model created the project under `/tmp/node-cli-demo` instead of the TUI `--cwd` workspace.
...
- Date: 2026-06-19
- Workspace: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-42FsdL`
- Log path: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-42FsdL/tui-interactive-shell-control.log`
...
- Date: 2026-06-19
- Workspace: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-Tb2QxZ`
- Log path: `/var/folders/bj/xcm3f3zx2z710fbv_jt6p3zr0000gn/T/demi-tui-interactive-shell-Tb2QxZ/tui-interactive-shell-control.log`
...
- Compact behavior: after the model's final summary, TUI auto compacted once, resumed, rechecked `pwd`, `ls`, `qa.js`, and `server.js` in the same workspace, returned to idle, then closed on `/exit`.
- Independent shutdown check: `curl --max-time 2 -sS http://localhost:3000` exited 7 after TUI exit, proving the service was no longer listening.
- Negative checks: no actual `progress: shell[...] timeout`, no `node server.js &`, and no `/tmp/node-cli-demo` in the passing run log.

## Failure Analysis

The passing run is the fifth real TUI attempt. The earlier runs were not discarded because they found product-level friction that deterministic tests alone did not expose:
