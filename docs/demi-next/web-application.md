...
Host browser surface. Browser workpanel items project the Host's canonical tab
...
to the Host browser's debugging endpoint. This feature is not yet implemented.
