...
| M8 | Manifest build and hash stability; loader dispatch for both kinds; runtime-module conformance under Bun, shell and fixture; tinybash grammar table and the bash-equivalence corpus run against real bash (`tinybash.md`); parse-first and cancellation cases; hostless conversation runs file and todo; third-party embedding example. |
