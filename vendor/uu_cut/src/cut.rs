...
use uucore::context::io::{BufRead, BufReader, BufWriter, IsTerminal, Read, Write, stdin, stdout};
use std::path::Path;
...
impl CharCut<'_> {
    ...
    /// line.
    #[inline(always)]
    fn write_line<W: Write>(&self, line: &[u8], out: &mut W) -> uucore::context::io::Result<()> {
        let mut print_delim = false;
