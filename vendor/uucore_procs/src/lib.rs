...
pub fn main(args: TokenStream, stream: TokenStream) -> TokenStream {
    ...
    let new = quote!(
        ...
        pub fn uumain(args: impl uucore::Args) -> i32 {
            ...
            if uucore::context::utility_name().is_none() && !uucore::signals::sigpipe_was_ignored() {
            ...
            if uucore::context::utility_name().is_none() {
            ...
            match result {
                ...
                Err(e) => {
                    ...
                    if e.usage() {
                        use uucore::context::io::{stderr, Write as _};
