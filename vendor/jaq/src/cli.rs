...
type ArgsOs = std::vec::IntoIter<OsString>;
...
impl Cli {
    ...
    pub fn parse(args: Vec<OsString>) -> Result<Self, Error> {
    ...
    fn color_if(&self, f: impl Fn() -> bool) -> bool {
        ...
        let no_color = || uucore::context::env::var("NO_COLOR").is_ok_and(|v| !v.is_empty());
