//! Browser download command family.
...
/// Execute download within the invoking conversation's browser ownership.
pub(super) async fn execute(
    ...
    Err(BrowserError::UnsupportedCapability(
        "download implementation is pending the catalog checkpoint".into(),
    ))
}
