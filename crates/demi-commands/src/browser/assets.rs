...
/// Execute assets within the invoking conversation's browser ownership.
pub(super) async fn execute(
    ...
    Err(BrowserError::UnsupportedCapability(
        "assets implementation is pending the catalog checkpoint".into(),
    ))
}
