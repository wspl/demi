...
/// Execute fetch within the invoking conversation's browser ownership.
pub(super) async fn execute(
    ...
    Err(BrowserError::UnsupportedCapability(
        "fetch implementation is pending the catalog checkpoint".into(),
    ))
}
