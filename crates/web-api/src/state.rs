...
/// devices, the paired ones and the Cloud, the summaries of the user's
/// conversations, the active ones first, then the archived, and the Cloud's
/// status. The backend assembles it on each request, without waking a Cloud
