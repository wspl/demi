...
pub trait Formatter<T> {
    fn fmt(&self, writer: impl Write, x: T) -> crate::context::io::Result<()>;
...
impl Formatter<i64> for SignedInt {
    fn fmt(&self, writer: impl Write, x: i64) -> crate::context::io::Result<()> {
...
impl Formatter<u64> for UnsignedInt {
    fn fmt(&self, writer: impl Write, x: u64) -> crate::context::io::Result<()> {
...
impl Formatter<&ExtendedBigDecimal> for Float {
    fn fmt(&self, writer: impl Write, e: &ExtendedBigDecimal) -> crate::context::io::Result<()> {
...
fn write_padding(writer: &mut impl Write, byte: u8, mut len: usize) -> crate::context::io::Result<()> {
