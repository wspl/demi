...
use std::cmp;
use std::fmt::Write;
use uucore::context::io::{BufReader, Read};
...
pub fn uumain(args: impl uucore::Args) -> UResult<()> {
    ...
    let mut out = uucore::context::io::stdout().lock();
...
fn extract_strings_from_input(
    ...
    min_length: usize,
    radix: Radix,
    writer: &mut impl uucore::context::io::Write,
) -> UResult<()> {
    ...
    let mut print_string = |offset: u64, string: &[u8]| -> uucore::context::io::Result<()> {
