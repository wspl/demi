...
use uucore::context::io::{Read, Write};
...
/// actually reading it.
///
/// Like `uucore::context::io::Read`, it allows to read data from a stream, with
...
/// Wrapper for `uucore::context::io::Read` allowing to peek into the data to be read.
...
mod tests {
    use super::*;
    use uucore::context::io::{Cursor, Read};
