...
use {std::cell::RefCell, std::fmt::Display, uucore::context::fs::OpenOptions, uucore::context::io::stderr, uucore::context::io::BufRead, uucore::context::io::BufReader, uucore::context::io::BufWriter, uucore::context::io::Write, std::path::PathBuf, std::rc::Rc, std::str::FromStr, std::time::SystemTime};
...
fn do_updatedb(args: &[&str]) -> UResult<()> {
    ...
    let write_err = |e: uucore::context::io::Error| {
        USimpleError::new(
            1,
            format!(
                "error writing '{}': {}",
