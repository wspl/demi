...
//!         uucore::context_println!("{} -> {:?}", entry.path.display(), entry.file_type);
//!         self.count += 1;
//!         Ok(())
//!     }
//! }
...
//! uucore::context_println!("processed {} entries", output.count);
//! ```
