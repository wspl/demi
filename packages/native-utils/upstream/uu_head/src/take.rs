...
use uucore::context::io::{ErrorKind, Read, Write};
...
impl TakeAllBuffer {
    ...
    fn fill_buffer(&mut self, reader: &mut impl Read) -> uucore::context::io::Result<usize> {
    ...
    fn write_bytes_exact(&mut self, writer: &mut impl Write, bytes: usize) -> uucore::context::io::Result<()> {
    ...
    fn write_all(&mut self, writer: &mut impl Write) -> uucore::context::io::Result<usize> {
...
impl TakeAllLinesBuffer {
    ...
    fn fill_buffer(
        ...
        reader: &mut impl Read,
        separator: u8,
    ) -> uucore::context::io::Result<BytesAndLines> {
...
/// Like `uucore::context::io::Take`, but for lines instead of bytes.
///
...
mod tests {
    ...
    use uucore::context::io::{BufRead, BufReader};
    ...
    fn test_take_all_buffer_exact_bytes() {
        ...
        let mut input_reader = uucore::context::io::Cursor::new(input_buffer);
        ...
        let mut output_reader = uucore::context::io::Cursor::new(vec![0x10; 0]);
    ...
    #[test]
    fn test_zero_lines() {
        let input_reader = uucore::context::io::Cursor::new("a\nb\nc\n");
