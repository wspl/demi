...
test(
  'streaming output_text deltas are not re-emitted on output_item.done (no duplication)',
  async () => {
...
test(
  'non-streaming output_item.done still emits the full message text once',
  async () => {
