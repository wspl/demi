...
//! in the primitive conformance suite, which is the definition of
//! done and runs as the embedded bundle so that it sees `tinyjs:*`.
...
pub const MODULES: &[(&str, &str)] = &[
    ...
    ("/embedded/net.mjs", include_str!("../conformance/net.mjs")),
    ("/embedded/protocol.mjs", include_str!("../conformance/protocol.mjs")),
