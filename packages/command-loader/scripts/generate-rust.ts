...
await writeFile(new URL('../src/generated.rs', import.meta.url), `// Generated from the TypeScript manifest contract.\n${[...generator.declarations.values()].join('\n\n')}\n`)
await writeFile(new URL('../src/manifest.schema.json', import.meta.url), `${JSON.stringify(z.toJSONSchema(manifestSchema), null, 2)}\n`)
