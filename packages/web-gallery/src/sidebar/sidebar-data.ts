...
export function demoConversations(): SidebarConversation[] {
  return [
    ...
    {
      id: 'c-regex',
      title: 'Regex for fenced code lines',
      updatedAt: ago(2 * DAY),
      status: 'idle',
      projectId: null,
      pinned: false,
    ...
    {
      id: 'c-cookie',
      title: 'Cookie helper refactor',
      updatedAt: ago(40 * 60 * 1000),
      status: 'done',
      projectId: 'p-demi',
      pinned: false,
      unread: true
    ...
    {
      id: 'c-tabs',
      title: 'Session tabs drag and drop',
    ...
    {
      id: 'c-shell',
      title: 'Shell preview budget as a function of the context window',
      updatedAt: ago(3 * DAY),
      status: 'idle',
      projectId: 'p-demi',
      pinned: false,
    ...
    {
      id: 'c-thumbs',
      title: 'Thumbnail pipeline on the new bucket',
      updatedAt: ago(DAY + 9 * HOUR),
      status: 'aborted',
      projectId: 'p-assets',
      pinned: false,
      unread: true
    ...
    {
      id: 'c-exif',
      title: 'Strip EXIF before upload',
      updatedAt: ago(4 * DAY),
      status: 'idle',
      projectId: 'p-assets',
      pinned: false,
