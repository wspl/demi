...
export function demoProjects(): SidebarProject[] {
  return [
    { id: 'p-demi', name: 'demi', host: 'zan-mbp', path: '/Users/zan/Projects/demi' },
    { id: 'p-assets', name: 'assetsfactory', host: 'build-01', path: '/srv/assetsfactory' },
    { id: 'p-dotfiles', name: 'dotfiles', host: 'zan-mbp', path: '/Users/zan/dotfiles' },
  ]
}
...
export function demoConversations(): SidebarConversation[] {
  return [
    ...
    { id: 'c-rate', title: 'Rate limit retry policy', updatedAt: ago(6 * HOUR), status: 'error', projectId: 'p-demi', pinned: false, unread: false },
    ...
    // assetsfactory
    { id: 'c-thumbs', title: 'Thumbnail pipeline on the new bucket', updatedAt: ago(DAY + 9 * HOUR), status: 'aborted', projectId: 'p-assets', pinned: false, unread: false },
