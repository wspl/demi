...
<template>
  <div
    class="rounded-lg border border-on-danger-muted bg-tint-danger px-3 py-2"
  >
    <div class="flex items-start gap-2">
      <pre
        class="m-0 min-w-0 flex-1 whitespace-pre-wrap break-words font-mono text-[12px] leading-5 text-on-danger"
      >{{ message }}</pre>
      <div
        v-if="copyable || dismissible"
