...
<template>
  ...
  <div class="absolute inset-0 flex select-none flex-col gap-3 overflow-hidden rounded-xl border border-line bg-surface-float p-4 text-fg">
    <div class="text-[11px] font-medium uppercase tracking-[0.04em] text-fg-subtle">Preview</div>
    ...
    <div class="flex gap-1.5">
      <div class="h-5 flex-1 rounded-md bg-surface-base ring-1 ring-line-subtle" />
      <div class="h-5 flex-1 rounded-md bg-surface ring-1 ring-line-subtle" />
      <div class="h-5 flex-1 rounded-md bg-surface-raised ring-1 ring-line-subtle" />
      <div class="h-5 flex-1 rounded-md bg-surface-float ring-1 ring-line-subtle" />
    </div>
