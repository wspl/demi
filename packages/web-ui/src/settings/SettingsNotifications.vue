...
<template>
  <SettingsPage title="Notifications" description="When the agent needs you, or is done.">
    <SettingsGroup title="Delivery">
      <SettingsRow label="Browser notifications" description="The browser asks once. Delivered while this tab is hidden.">
        <Switch v-model="browser" />
      </SettingsRow>
      <SettingsRow label="Sound" description="Only while this tab is in the background.">
        <Switch v-model="sound" />
      </SettingsRow>
    </SettingsGroup>
