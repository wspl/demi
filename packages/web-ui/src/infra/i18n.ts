...
const messages: Record<string, string> = {
  ...
  'agent.receipt.update': 'sent an update',
  'agent.receipt.completed': 'completed',
  'agent.receipt.failed': 'failed',
  'agent.receipt.aborted': 'aborted',
  'agent.block.thoughtBriefly': 'Thought briefly',
