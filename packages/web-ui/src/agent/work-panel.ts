...
/**
 * The work panel's fixed Change and File views, each with its own state
 * (`web-application.md` § Work panel). They are not tabs: the user's tabs live
 * in `panel-tabs.ts`.
 */
export type WorkTab = FileWorkTab | ChangeWorkTab

/** The fixed views of a conversation's work panel. */
