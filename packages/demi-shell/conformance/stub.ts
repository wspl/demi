...
const [httpPort, tlsPort, proxyPort] = (process.env.DEMI_SHELL_CONFORMANCE_PORTS ?? "").split(",").map(Number);
const cert = process.env.DEMI_SHELL_CONFORMANCE_CERT;
const key = process.env.DEMI_SHELL_CONFORMANCE_KEY;
